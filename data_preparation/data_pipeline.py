...
# data_preparer = TauPreparer(in_root_dir=in_root_dir, in_img_dir="images/test", in_label_dir="test_labels_new",
#                             prepared_root_dir=in_root_dir, prepared_img_dir="images/test", prepared_label_dir="test_labels_new", preprocessed_labels=True)
...
data_preparer_test = TauPreparer(in_root_dir=in_root_dir, in_img_dir="test_images_seg", in_label_dir="test_labels_new/new_labels",
                            prepared_root_dir=in_root_dir, prepared_img_dir="test_images_seg", prepared_label_dir="test_labels_new/new_labels",
